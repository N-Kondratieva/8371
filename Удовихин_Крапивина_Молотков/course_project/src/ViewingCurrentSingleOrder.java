...
public class ViewingCurrentSingleOrder {
    public static int ViewOrder() {
        final JFrame frame = new JFrame("Номер текущего заказа"); //Приделать номер заказа
        ...
        JButton buttonSendOrder = new JButton("Отправить заказ");
